...
export default function DigitalClock() {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <Card className="p-8 shadow-lg rounded-2xl bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200">
        <div className="flex flex-col items-center justify-center">
          {/* Header with title */}
          <div className="text-2xl font-bold tracking-tight text-gray-800">Digital Clock</div>
          {/* Description */}
